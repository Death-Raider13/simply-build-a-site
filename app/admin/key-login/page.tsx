...
export default function AdminKeyLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (adminKey === "NIGERIA_ADMIN_2024") {
      ...
      <main className="flex-1 flex items-center justify-center py-12 px-4">
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-2xl">Admin Key Required</CardTitle>
            <CardDescription>
              You have been authenticated as an admin. Please enter your admin key to access the administrative
              dashboard.
            </CardDescription>
          </CardHeader>
          <CardContent>
